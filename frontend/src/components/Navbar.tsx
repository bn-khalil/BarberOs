...
export function Navbar() {
    ...
    <nav className="flex justify-between items-center p-6 bg-slate-900 text-white shadow-lg">
      <h2 className="text-2xl font-bold text-brand">BarberShop</h2> {/* استخدمنا اللون brand هنا */}
      <ul className="flex space-x-8">
        ...
        <button className="px-4 py-2 text-sm font-medium bg-brand text-white rounded-lg hover:bg-blue-700 transition-all shadow-md cursor-pointer">
            Register
        </button>
        </div>
    </nav>
